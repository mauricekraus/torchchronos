...
class FourierTransform(Transform):
    ...
    def __init__(self) -> None:
        """
        Initializes a new instance of the FourierTransform class.
        """
        super().__init__(True)
    ...
    def _transform(
        ...
        """
        Applies the Fourier transform to the given time series data.
        ...
        Returns:
            tuple[torch.Tensor, Optional[torch.Tensor]]: The Fourier transformed data and the targets (if provided).
        """
    ...
    def _invert(self):
        """
        Returns an instance of the InverseFourierTransform class.
    ...
    def __repr__(self) -> str:
        """
        Returns a string representation of the FourierTransform object.
...
class InverseFourierTransform(Transform):
    """
    This class represents the inverse Fourier transform.
    ...
    def _transform(
        ...
        """
        Applies the inverse Fourier transform to the given time series and targets.
    ...
    def __repr__(self) -> str:
        """
        Returns a string representation of the InverseFourierTransform object.
