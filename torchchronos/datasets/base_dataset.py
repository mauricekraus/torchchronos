...
class BaseDataset(Dataset):
    ...
    ----------
        ...
        targets (torch.Tensor | None): The target tensor (optional).

    """

    def __init__(self, data: torch.Tensor, targets: torch.Tensor | None = None):
        """
    ...
    def __getitem__(self, idx: int) -> torch.Tensor | tuple[torch.Tensor, torch.Tensor]:
        """
        Retrieve a single item or a tuple of data and target at the given index.
